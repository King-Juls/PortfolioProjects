...
-- The top 3 companies with highest layoff each year from 2020-2023
...
-- Layoffs trend per year
SELECT TO_CHAR(date, 'MM-YYYY') AS month, SUM(total_laid_off) AS sum_laid_off
FROM layoffs_staging2
WHERE total_laid_off IS NOT NULL
